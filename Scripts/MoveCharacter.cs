...
public class MoveCharacter : MonoBehaviour
{
    ...
    public Animator animator, arms;
    public GameObject bodyVisible, armsVisible;
    ...
    void Start()
    {
        ...
        {
            bodyVisible.SetActive(false);
            armsVisible.SetActive(false);
        }
    }
    ...
    public void Punch()
    {
        if (Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D))
        {
            ...
            arms.SetTrigger(AnimationParameters.triggers["punch"]);
        }
        else
        {
            animator.SetTrigger(AnimationParameters.triggers["idlePunch"]);
            arms.SetTrigger(AnimationParameters.triggers["idlePunch"]);
        }
    }
